const CACHE="ferconvert-v4-3-pro";
const CORE=["./","./index.html","./privacy.html","./manifest.json","./assets/logo/logo.svg","./assets/icons/icon-192.png","./assets/icons/icon-512.png"];
